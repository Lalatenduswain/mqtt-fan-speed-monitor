/*
 * Bedroom Configuration Example
 *
 * Devices:
 * - 2 lights (main + bedside lamp)
 * - 1 ceiling fan with speed control
 * - AC (IR)
 * - Temperature sensor
 *
...
#define RELAY_2_NAME       "light2"      // Bedside lamp
#define RELAY_3_NAME       "fan"         // Ceiling fan
#define RELAY_4_NAME       "night_lamp"  // Night lamp (low power)

#define RELAY_1_TYPE       "light"
#define RELAY_2_TYPE       "light"
#define RELAY_3_TYPE       "fan"
#define RELAY_4_TYPE       "light"

// ============================================================
// IR CONFIGURATION (AC only, no TV)
// ============================================================
...
// ============================================================
// POWER MONITORING (Disabled for bedroom)
// ============================================================

#define ENABLE_POWER_MONITOR   false
#define NUM_POWER_SENSORS      0
